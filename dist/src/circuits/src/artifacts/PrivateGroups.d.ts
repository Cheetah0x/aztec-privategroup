import { AztecAddress, type AztecAddressLike, type ContractArtifact, ContractBase, ContractFunctionInteraction, type ContractMethod, type ContractStorageLayout, type ContractNotes, DeployMethod, type FieldLike, PublicKeys, type Wallet } from "@aztec/aztec.js";
...
export declare class PrivateGroupsContract extends ContractBase {
     ...
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, admin: AztecAddressLike, group_members: AztecAddressLike[]): DeployMethod<PrivateGroupsContract>;
    /**
    ...
    static get notes(): ContractNotes<"NewAddressNote" | "ValueNote">;
