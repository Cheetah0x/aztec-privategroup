...
import PrivateGroupsContractArtifactJson from "../../../target/private_groups-PrivateGroups.json" assert { type: "json" };
...
export class PrivateGroupsContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      PrivateGroupsContract.artifact,
      wallet
    ) as Promise<PrivateGroupsContract>;
  }
  ...
  public static get storage(): ContractStorageLayout<
    "admin" | "group_members" | "group_balances_credit" | "group_balances_debt"
  > {
    return {
      admin: {
        slot: new Fr(1n),
